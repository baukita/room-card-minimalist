...
export interface Translations {
	...
	add_stat: string;
	stat_type: string;
	stat_type_entity: string;
	stat_type_template: string;
	stat_entity: string;
	stat_icon: string;
	stat_icon_off: string;
	stat_value: string;
	stat_color: string;
	stat_color_off: string;
	stat_label: string;
	stat_show_label: string;
	stat_hide_if_empty: string;
	stat_hide_when_off: string;
	stat_show_unit: string;
	stat_on_state: string;
	states: string;
	add_state: string;
	state_type: string;
